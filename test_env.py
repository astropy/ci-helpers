...
if not LooseVersion(sys.version) < '3.5':
    LATEST_ASTROPY_STABLE = '3.1.1'
    LATEST_ASTROPY_STABLE_WIN = '3.1.1'
else:
    LATEST_ASTROPY_STABLE = '2.0.11'
    LATEST_ASTROPY_STABLE_WIN = '2.0.11'

LATEST_ASTROPY_LTS = '2.0.11'
LATEST_ASTROPY_LTS_WIN = '2.0.11'
