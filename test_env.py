...
if not LooseVersion(sys.version) < '3.5':
    LATEST_ASTROPY_STABLE = '3.0.3'
    LATEST_ASTROPY_STABLE_WIN = '3.0.3'
else:
    LATEST_ASTROPY_STABLE = '2.0.7'
    LATEST_ASTROPY_STABLE_WIN = '2.0.7'

LATEST_ASTROPY_LTS = '2.0.7'
LATEST_NUMPY_STABLE = '1.14'
LATEST_SUNPY_STABLE = '0.9.1'
