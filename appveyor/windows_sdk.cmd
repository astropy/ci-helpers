...
IF NOT "x%APPVEYOR_REPO_COMMIT_MESSAGE:[docs only]=%"=="x%APPVEYOR_REPO_COMMIT_MESSAGE%" (
   EXIT 0
)

IF NOT "x%APPVEYOR_REPO_COMMIT_MESSAGE_EXTENDED:[docs only]=%"=="x%APPVEYOR_REPO_COMMIT_MESSAGE_EXTENDED%" (
   EXIT 0
)
